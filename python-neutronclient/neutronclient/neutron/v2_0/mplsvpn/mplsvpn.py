...
from neutronclient.neutron.v2_0.mplsvpn import utils as mplsvpn_utils
...
class CreateMPLSVPN(neutronv20.CreateCommand):
    ...
    def add_known_arguments(self, parser):
        ...
        parser.add_argument(
            '--name', default='',
            help=_('The MPLSVPN name to assign.  If not provided, a name will be autogenerated.'))
        parser.add_argument(
            '--tunnel-type', default='fullmesh',
            choices=['fullmesh', 'Customized'],
            help=_('LSP tunnel type, default: fullmesh. Other option: Customized'))
        parser.add_argument(
            '--tunnel-backup', default='frr',
            choices=['frr', 'Secondary'],
            help=_('Tunnel failover option, default: frr. Other option: Secondary'))
        parser.add_argument(
            '--qos', default='Gold',
            choices=['Gold', 'Silver', 'Bronze'],
            help=_('Tunnel qos, default: Gold.  Other options: Silver, Bronze'))
        parser.add_argument(
            '--bandwidth', default='10',
            help=_('Tunnel bandwidth, default: 10.'))
        parser.add_argument(
            '--attachment-circuits', type=string.split,
            help=_('List of whitespace-delimited attachment circuit names or IDs; e.g., --attachment-circuits \"ac1 ac2\"'))
    ...
    def args2body(self, parsed_args):
        ...
        if parsed_args.attachment_circuits:
            ...
            body['mplsvpn'].update({'attachment_circuits': _attachment_circuits})
...
class UpdateMPLSVPN(neutronv20.UpdateCommand):
    ...
    def add_known_arguments(self, parser):
        ...
        parser.add_argument(
            '--attachment-circuits', type=string.split,
            help=_('List of whitespace-delimited attachment circuit names or IDs; e.g., --attachment-circuits \"ac1 ac2\".  To remove last attachment circuit, specify \"none\".'))
