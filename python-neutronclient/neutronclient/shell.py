...
from neutronclient.neutron.v2_0.mplsvpn import attachmentcircuit
from neutronclient.neutron.v2_0.mplsvpn import mplsvpn
from neutronclient.neutron.v2_0.mplsvpn import provideredge
...
COMMAND_V2 = {
    ...
    'mplsvpn-service-list': mplsvpn.ListMPLSVPN,
    'mplsvpn-service-show': mplsvpn.ShowMPLSVPN,
    'mplsvpn-service-create': mplsvpn.CreateMPLSVPN,
    'mplsvpn-service-update': mplsvpn.UpdateMPLSVPN,
    'mplsvpn-service-delete': mplsvpn.DeleteMPLSVPN,
    'mplsvpn-attachmentcircuit-list': attachmentcircuit.ListAttachmentCircuit,
    'mplsvpn-attachmentcircuit-show': attachmentcircuit.ShowAttachmentCircuit,
    'mplsvpn-attachmentcircuit-create': attachmentcircuit.CreateAttachmentCircuit,
    'mplsvpn-attachmentcircuit-update': attachmentcircuit.UpdateAttachmentCircuit,
    'mplsvpn-attachmentcircuit-delete': attachmentcircuit.DeleteAttachmentCircuit,
    'mplsvpn-provideredge-list': provideredge.ListProviderEdge,
    'mplsvpn-provideredge-show': provideredge.ShowProviderEdge,
    'mplsvpn-provideredge-create': provideredge.CreateProviderEdge,
    'mplsvpn-provideredge-delete': provideredge.DeleteProviderEdge, 
}
