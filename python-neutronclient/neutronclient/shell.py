...
COMMAND_V2 = {
    ...
    'mplsvpn-attachmentcircuit-create':
        attachmentcircuit.CreateAttachmentCircuit,
    'mplsvpn-attachmentcircuit-update':
        attachmentcircuit.UpdateAttachmentCircuit,
    'mplsvpn-attachmentcircuit-delete':
        attachmentcircuit.DeleteAttachmentCircuit,
...
class NeutronShell(app.App):
    ...
    def authenticate_user(self):
        """Make sure the user has provided all of the auth info we need."""
