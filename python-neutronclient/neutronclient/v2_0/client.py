...
class Client(object):
    ...
    def list_attachment_circuits(self, retrieve_all=True, **_params):
        ...
        return self.list('attachment_circuits', self.attachment_circuits_path, retrieve_all,
                         **_params)

    @APIParamsCall
    def show_attachment_circuit(self, attachment_circuit, **_params):
        """Fetches information of a specific AttachmentCircuit."""
        return self.get(self.attachment_circuit_path % (attachment_circuit), params=_params)
    ...
    def update_attachment_circuit(self, attachment_circuit, body=None):
        ...
        return self.put(self.attachment_circuit_path % (attachment_circuit), body=body)
    ...
    def list_provider_edges(self, retrieve_all=True, **_params):
        ...
        return self.list('provider_edges', self.provider_edges_path, retrieve_all,
                         **_params)

    @APIParamsCall
    def show_provider_edge(self, provider_edge, **_params):
        """Fetches information of a specific ProviderEdge."""
        return self.get(self.provider_edge_path % (provider_edge), params=_params)
