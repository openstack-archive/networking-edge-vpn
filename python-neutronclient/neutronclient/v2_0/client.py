...
class APIParamsCall(object):
    """Decorator for format and tenant overriding and filters."""
...
class Client(object):
    ...
    mplsvpns_path = "/mplsvpn/mplsvpns"
    mplsvpn_path = "/mplsvpn/mplsvpns/%s"
    provider_edges_path = "/mplsvpn/provider-edges"
    provider_edge_path = "/mplsvpn/provider-edges/%s"
    attachment_circuits_path = "/mplsvpn/attachment-circuits"
    attachment_circuit_path = "/mplsvpn/attachment-circuits/%s"
    ...
    EXTED_PLURALS = {'routers': 'router',
                     ...
                     'mplsvpns': 'mplsvpn',
                     'provider_edges': 'provider_edge',
                     'attachment_circuits': 'attachment_circuit'
                     }
    ...
    def get_quotas_tenant(self, **_params):
        """Fetch tenant info in server's context for quota operation."""
    ...
    @APIParamsCall
    def list_mplsvpns(self, retrieve_all=True, **_params):
        """Fetches a list of all configured MPLSVPNs for a tenant."""
        return self.list('mplsvpns', self.mplsvpns_path, retrieve_all,
                         **_params)

    @APIParamsCall
    def show_mplsvpn(self, mplsvpnservice, **_params):
        """Fetches information of a specific MPLSVPN."""
        return self.get(self.mplsvpn_path % (mplsvpnservice), params=_params)

    @APIParamsCall
    def create_mplsvpn(self, body=None):
        """Creates a new MPLS VPN."""
        return self.post(self.mplsvpns_path, body=body)

    @APIParamsCall
    def update_mplsvpn(self, mplsvpnservice, body=None):
        """Updates a MPLSVPN."""
        return self.put(self.mplsvpn_path % (mplsvpnservice), body=body)

    @APIParamsCall
    def delete_mplsvpn(self, mplsvpnservice):
        """Deletes the specified MPLS VPN."""
        return self.delete(self.mplsvpn_path % (mplsvpnservice))

    @APIParamsCall
    def list_attachment_circuits(self, retrieve_all=True, **_params):
        """Fetches a list of all configured AttachmentCircuits for a tenant."""
        return self.list('attachment_circuits',
                         self.attachment_circuits_path, retrieve_all,
                         **_params)

    @APIParamsCall
    def show_attachment_circuit(self, attachment_circuit, **_params):
        """Fetches information of a specific AttachmentCircuit."""
        return self.get(self.attachment_circuit_path % (attachment_circuit),
                        params=_params)

    @APIParamsCall
    def create_attachment_circuit(self, body=None):
        """Creates a new AttachmentCircuit."""
        return self.post(self.attachment_circuits_path, body=body)

    @APIParamsCall
    def update_attachment_circuit(self, attachment_circuit, body=None):
        """Updates an AttachmentCircuit."""
        return self.put(self.attachment_circuit_path % (attachment_circuit),
                        body=body)

    @APIParamsCall
    def delete_attachment_circuit(self, attachment_circuit):
        """Deletes the specified AttachmentCircuit."""
        return self.delete(self.attachment_circuit_path % (attachment_circuit))

    @APIParamsCall
    def list_provider_edges(self, retrieve_all=True, **_params):
        """Fetches a list of all configured ProviderEdges for a tenant."""
        return self.list('provider_edges', self.provider_edges_path,
                         retrieve_all, **_params)

    @APIParamsCall
    def show_provider_edge(self, provider_edge, **_params):
        """Fetches information of a specific ProviderEdge."""
        return self.get(self.provider_edge_path % (provider_edge),
                        params=_params)

    @APIParamsCall
    def create_provider_edge(self, body=None):
        """Creates a new ProviderEdges."""
        return self.post(self.provider_edges_path, body=body)

    @APIParamsCall
    def delete_provider_edge(self, provider_edge):
        """Deletes the specified ProviderEdges."""
        return self.delete(self.provider_edge_path % (provider_edge))
