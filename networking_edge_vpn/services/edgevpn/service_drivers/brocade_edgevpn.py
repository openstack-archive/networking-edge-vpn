    ...
    def create_edgevpn(self, context, edgevpn):
        ...
        with context.session.begin(subtransactions=True):
            ...
            try:
                ...
                raise EdgeVPNException(vpn_id=vpls_id)
...
class EdgeVPNInvalidRequest(exceptions.InvalidInput):
    message = "No vpn_id specified for edgevpn service, exiting"


class EdgeVPNException(exceptions.NeutronException):
    message = _("Error while creating Edge VPN with ID %(vpn_id)s.")
